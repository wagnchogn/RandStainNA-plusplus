...
parser.add_argument('--data-dir', type=str, metavar='DIR', default='/media/wagnchogn/data_16t/NCT/NCT-CRC-HE-100K-NONORM',
                    help='path to dataset(ImageFolder form)') 
parser.add_argument('--save-dir', type=str, metavar='DIR',default='/media/wagnchogn/data/wsi_augmentation/randstiannav2-master/crc',
                    help='path to save dataset')
parser.add_argument('--dataset-name', type=str, default='CRC', metavar='DIR',
