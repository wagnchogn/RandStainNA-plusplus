...
def create_loader(
        ...
        fft_aug=None, #6.20添加
        randstainna_attention_enabled=None, #9.24添加
        auto_augment=None,
        num_aug_repeats=0,
        num_aug_splits=0,
    ...
    dataset.transform = create_transform(
        ...
        fft_aug=fft_aug, #6.20添加
        randstainna_attention_enabled=randstainna_attention_enabled, # 9.24
    ...
    elif nj_dynamic or ddsgd : #2.17添加，修改sampler for concat dataset
        if is_training:
