...
from .dataset import IterableImageDataset, ImageDataset, CRC_ours
...
def create_dataset(
        ...
        load_bytes=False,
        is_training=False,
        randstainna_attention=None,  # 9.24添加
        download=False,
        batch_size=None,
        repeats=0,
        cam_name = None,
    ...
    if name.startswith('torch/'):
        ...
        elif name == 'image_folder' or name == 'folder' or is_training == False:
        ...
        elif name == 'randstainna_cv':
            ds = CRC_ours(root, randstainna_attention=randstainna_attention,cam_name=cam_name)
            print('CRC dataset randstainna_cv') #9.24添加
        else:
